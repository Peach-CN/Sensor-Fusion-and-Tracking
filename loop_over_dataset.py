...
while True:
    try:
        ...
        if 'pcl_from_rangeimage' in exec_list:
            ...
            print('loading lidar point-cloud from result file') #(num_points,4)
        ...
        if 'measure_detection_performance' in exec_list:
            ...
            det_performance = eval.measure_detection_performance(detections, frame.laser_labels, valid_label_flags, configs_det.nms_thresh)
        else:
        ...
        if 'show_range_image' in exec_list:
            ...
            cv2.imshow('ID_S1_EX1:range_image', img_range)
            cv2.imwrite("./EX_results/ID_S1_EX1-range_image.jpg", img_range)
